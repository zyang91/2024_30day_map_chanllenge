...
query <- "
  ...
  FROM (
    SELECT '2010' AS YEAR, STATE, AGE, INJ_SEV FROM person2010
    UNION ALL
    SELECT '2011' AS YEAR, STATE, AGE, INJ_SEV FROM person2011
    UNION ALL
    SELECT '2012' AS YEAR, STATE, AGE, INJ_SEV FROM person2012
    UNION ALL
    SELECT '2013' AS YEAR, STATE, AGE, INJ_SEV FROM person2013
    UNION ALL
    SELECT '2014' AS YEAR, STATE, AGE, INJ_SEV FROM person2014
    UNION ALL
    SELECT '2015' AS YEAR, STATE, AGE, INJ_SEV FROM person2015
    UNION ALL
    SELECT '2016' AS YEAR, STATE, AGE, INJ_SEV FROM person2016
    UNION ALL
    SELECT '2017' AS YEAR, STATE, AGE, INJ_SEV FROM person2017
    UNION ALL
    SELECT '2018' AS YEAR, STATE, AGE, INJ_SEV FROM person2018
    UNION ALL
    SELECT '2019' AS YEAR, STATE, AGE, INJ_SEV FROM person2019
    UNION ALL
    SELECT '2020' AS YEAR, STATE, AGE, INJ_SEV FROM person2020
    UNION ALL
    SELECT '2021' AS YEAR, STATE, AGE, INJ_SEV FROM person2021
    UNION ALL
    SELECT '2022' AS YEAR, STATE, AGE, INJ_SEV FROM person2022
  ) AS all_YEARs
  WHERE AGE < 19 AND INJ_SEV = 4
  GROUP BY YEAR, STATE, INJ_SEV
  ORDER BY YEAR, STATE, INJ_SEV
"
# Execute the query
...
ggplot(states_sf) +
  ...
  labs(title='Change in Child Traffic Fatalities across US states',
       ...
       caption = 'Source: NHTSA FARS 2010-2022\nCreated by Zhanchao Yang',
